<script>
  ...
  async function geocode(lat, lon) {
    ...
    let geoApi = `https://revgeocode.search.hereapi.com/v1/revgeocode?at=${lat}%2C${lon}&types=area,city&lang=${$locale}&limit=1&apiKey=9QbyENb6bbNAiAYxoVHHNDYkPRmXYMcllMPeFKhQ2ZY`
    console.log(geoApi)
